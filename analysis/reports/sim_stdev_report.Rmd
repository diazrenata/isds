---
title: "Effect of st.dev. on sim ISD"
author: "Renata Diaz"
date: "7/1/2019"
...
```{r empirical plots, fig.height = 5, fig.width = 5}
...
```{r sim plots, fig.height = 25, fig.width = 20}
...
```{r nb modes plot, eval = F, include = F}
