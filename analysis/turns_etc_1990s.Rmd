...
all_kdes <- read.csv(here::here("all_kdes_1990s.csv"), stringsAsFactors = F)
all_isds <- read.csv(here::here("all_isds_1990s.csv"), stringsAsFactors = F) 
all_gmms <- read.csv(here::here("all_gmms_1990s.csv"), stringsAsFactors = F)
...
```{r by edge ratio plot alpha, fig.dim=c(40,40)}
